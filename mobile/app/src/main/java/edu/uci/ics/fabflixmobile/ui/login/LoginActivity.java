        ...
        final StringRequest loginRequest = new StringRequest(Request.Method.POST, baseURL + "/api/login", response -> {
                    ...
                    try {
                        ...
                        if(json.getString("status").equals("success")){
                            ...
                            message.setText("Works");
                            Intent MovieListPage = new Intent(LoginActivity.this, MainPageActivity.class); // redirect to the search page after login
                            //without starting the activity/page, nothing would happen
                            startActivity(MovieListPage);
                        }
                        else{
                            message.setText("ERROR: " + json.getString("message"));
                        }
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("mobile", "true"); // needs this to bypass missing captcha
                return params;
            }
        };
